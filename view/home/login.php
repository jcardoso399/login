...
<div class="fondo-login">
    <div class="icon">
        ...
        <i class="fa-solid fa-burger dog-icon"></i>
        </a>
    </div>
    <div class="titulo">
        Inicia sesion en BurguerHouse
    </div>
    ...
    <div class="login col-3 mt-3">
        Nuevo en BurgerHouse? <a href="signup.php" style="text-decoration: none;">Create una cuenta</a>
    </div>
</div>
